  ...
  return (
    <div className='bg-neutralSilver' id="home" >
        ...
        <Carousel className='w-full mx-auto'>
            ...
            <div className=" my-28 md:my-8 py-12 flex flex-col md:flex-row-reverse items-center justify-between gap-12">
                <div><img src={image} className='w-[800px] h-[500px]'/></div>
                <div className='md:w-1/2'>
                    <h1 className='text-5xl font-semibold mb-4 text-neutralDGrey md:w-3/4 leading-snug'>"There are more life forms in a handful of forest soil than there are people on the planet."<br/><span className=' text-xl text-brandPrimary leading-snug'>— Peter Wohlleben</span></h1>
                    <button className='px-7 py-2 bg-brandPrimary text-white rounded hover:bg-neutralDGrey transition-all duration-300 hover:-translate-y-4'>Register</button>
                </div>
            </div>
            <div className=" my-28 md:my-8 py-12 flex flex-col md:flex-row-reverse items-center justify-between gap-12">
                <div><img src={img11} className='h-[500px]'/></div>
                <div className='md:w-1/2'>
                    <h1 className='text-5xl font-semibold mb-4 text-neutralDGrey md:w-3/4 leading-snug'>"He who plants a tree plants a hope"<br/><span className=' text-xl text-brandPrimary leading-snug'>-Lucy Larcom</span></h1>
                    <button className='px-7 py-2 bg-brandPrimary text-white rounded hover:bg-neutralDGrey transition-all duration-300 hover:-translate-y-4'>Register</button>
                </div>
            </div>
        </Carousel>
